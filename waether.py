...
Fbutton = tk.Button(frame, text="Fahrenheit", font='times 13', command=lambda: get_weather(entry.get()))
Fbutton.place(relx=0.53, rely=0, relheight=1, relwidth=0.25)

Cbutton = tk.Button(frame, text="Celsius", font='times 13', command=lambda: get_weatherM(entry.get()))
Cbutton.place(relx=0.8, rely=0, relheight=1, relwidth=0.25)
